...
func TestNegativeOffset(t *testing.T) {
	err := Copy("testdata/input.txt", "/tmp/out.txt", -10, 0)
	require.Error(t, err)
}

func TestNegativeLimit(t *testing.T) {
	err := Copy("testdata/input.txt", "/tmp/out.txt", 0, -1)
	require.Error(t, err)
}

func TestNoFromFile(t *testing.T) {
	err := Copy("filename", "/tmp/out.txt", 0, 0)
	require.Error(t, err)
}
...
func TestOffsetExceedsFileSize(t *testing.T) {
	err := Copy("testdata/input.txt", "/tmp/out.txt", 1000000, 0)
...
func TestNoPermFromFile(t *testing.T) {
	...
	err := Copy("fromFile", "/tmp/out.txt", 0, 0)
	require.Error(t, err)
}
